...
from INTERFACE_bluetooth_devices import Ui_bluetooth_devices_window
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, screen):
        ...
        self.blue_btn.clicked.connect(blue)
    ...
    def bluetoothPage(self, home_window):
        self.win = QtWidgets.QMainWindow()
        self.devices = Ui_bluetooth_devices_window()
        self.devices.setupUi(self.win, home_window, self.screen_size)
        self.win.show()
